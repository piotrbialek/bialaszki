<div class="invitation-card">
    <div class="month seasons-style main-color">CZERWIEC</div>
...
<!--                    <div class="location-address"><br></div>-->
    ...
    <?php include __DIR__ . '/countdown_view.php'; ?>
    <div class="centered-date-container">
        <?php include __DIR__ . '/date.php'; ?>
    </div>
